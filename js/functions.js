...
var billTotal = 100
console.log(calcuateTip(tipPercentage,billTotal))
 ...
 */
function applyDiscount(ogPrice,discountP){
    return (ogPrice - (ogPrice * discountP))
}
var ogPrice= 220
var discountP=.2
console.log(applyDiscount(ogPrice,discountP))